...
### Push Battleとは
* Push Battleはお尻の妖精である「ケップリン」を操作し、他のキャラクターにお尻をぶつけてフィールドから落とす、マルチプレイアクションゲームです。
...
#### お尻アタックはエビから生まれた
* 私はケップリンの誕生に合わせ、ケップリンのためのお尻アタック(以下 スマッシュ)を考える必要がありました。
...
### Push Battle まとめ
* Push Battleの制作を通して、プログラミングの面白さと大変さを学べました。
* マルチプレイの問題の修正を振り返ってみると、本当に根気がいる作業であったと思います。作業内容は作成したスクリプトを見直し、改善方法を考え、修正するという細かい作業であったため、正直に感想を述べると苦しかったです。
私は、遊べるゲームをプレイヤーに届けたいという一心で作業を行っていたように思います。
* マルチプレイ問題を修正しているときに、修正内容が効果的かどうかの検証をしていました。検証は遊びでなく、本気で行っていたのですが、「プログラマーっぽいこと」をすることができて、少しワクワクしたことを覚えています。
