...
#### 「触れる」「近くで見る」
「触れる」と「近くで見る」はインタラクションのアクション部分になります。アクション単体で見るとユニークさはなく、インパクトにも欠けています。
しかし、この2つのアクションは他の要素を尊重しており、ゲームに馴染むように設計されています。

#### 協調性のあるアクション
<img width = "600" src="Images/interaction_2.png">

**"ボタン入力を使用しないことにより、没入感を損なわさせない"**
* ゲーム内で手に機械や装置を握っている場合はコントローラーのボタン入力を押すことに違和感は出ません。
* しかし、手に何も握っていない場合にボタン入力を行うことは違和感があり、途端に「ゲームチック」に感じてしまいます。これはVR特有の「現実に近い」という利点を活かせないものになってしまいます。
* 以上の理由から、2つのアクションはボタン入力をしないことにより、没入感を損なわさせない工夫がされています。

**"ハイハイを活かし補う"**
* 「触れる」の利点はハイハイしていた状態から、手を伸ばすだけで行えることです。移動とアクションがスムーズに行えることはプレイヤーにストレスを与えないため、よりゲーム体験に集中してもらうことができます。
* 「近くで見る」があることによって、手が届かない所にインタラクトすることができます。このアクションがあることによってゲーム内の空間を最大限有効活用することができ、プレイヤーにより自由さを感じさせることができます。
...
**このように、アクションを他の要素と合わせて作ることによって、直観的で没入感を考慮した自然なアクションに仕上げることができました。**
