...
* **連絡する際のメッセージを工夫する重要性** : 
	* 絵文字を付けることによって柔らかい表現をすることができ、コミュニケーションを円滑に行える場合がある。
	* また、絵文字を使わずとも文章を丁寧に書くことは受けての印象を良くするため「重要な内容だけ伝わればいいや」という安易な考えはダメ絶対。(失敗経験あり)
* **心に余裕を持つことの大切さ** : 余裕を持って会話することによって「言葉に言葉を返す」ような無駄な会話に発展しなくなり、有意義な会話を行うことができる。
* **よく話しを聞くこと** : 
...
## 【課題】
現在の私の課題
* 私のゲーム作りの目的を正確に捉え、目的を達成するための策を出す。
* 技術力を向上させる
* 人と繋がり知見を得る
* ゲームデザインを研鑽する
* 丁寧なテキストチャットを心がける！
