...
* 私は理想のスマッシュをイメージして、実際にスマッシュをしました。その時に「少し浮く」という発見がありました。さらに、私は実際に後ろ向きに突進するモノを探しているときに、エビを見つけました。私はエビの勢い良く動いた後の「自然な減速」に感動し、それを参考にしました。
* スマッシュは「自然さ」を取り入れることによって、"しっくり"くる動きにすることが出来ました。
