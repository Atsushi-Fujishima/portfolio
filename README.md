...
* 求めているシステムを作成する上で、最も困難であったのが「片手だけでは移動させない」でした。ハイハイは両手を使って動くのが一般的であるためです。
...
Image
* どちらのシステムを試した後、私たちは「操作性の良さ」を優先させました。親しみのない操作であるからこそ、プレイヤーのやりやすさを重視すべきと判断したためです。
* ハイハイの操作がやりやすいものになることによって、ハイハイをストレスなく楽しめるものに作りあげることが出来ました。

**"ハイハイシステムの歴史 5 : まとめ"**
* "ハイハイシステムの歴史"ではハイハイのシステムをいくつかピックアップして紹介させていただきました。
* ハイハイは、いくつもの問題を解決しつつ段階的により良くすることによって、プレイヤーが違和感を感じず、操作性の良いアクションにすることができました。
